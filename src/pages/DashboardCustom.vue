  ...
  <q-page padding>
    ...
    <div class="row q-col-gutter-md q-mt-md">
      <div class="col-12 relative-position">
        <AreaChart2 v-if="!filteredAreaChartData.isLoading" :data="filteredAreaChartData" title="Materiales Recolectados por Mes" />
...
const filteredAreaChartData = ref<ChartData>(
{
  labels: ['Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio'],
    datasets: [
  {
    label: 'Plástico PET (Kg)',
    data: [1500, 400, 800, 900, 1100, 1000],
    borderColor: '#4CAF50',
    backgroundColor: '#4CAF50',
  },
  {
    label: 'Plástico PP (Kg)',
    data: [800, 950, 100, 250, 700, 550],
    borderColor: '#2196F3',
    backgroundColor: '#2196F3',
  },
      {
        label: 'Plástico HDPE (Kg)',
